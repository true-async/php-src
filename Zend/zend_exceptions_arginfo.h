...
#define arginfo_class_Cancellation___clone arginfo_class_Exception___clone

#define arginfo_class_Cancellation___construct arginfo_class_Exception___construct

#define arginfo_class_Cancellation___wakeup arginfo_class_Exception___wakeup

#define arginfo_class_Cancellation_getMessage arginfo_class_Throwable_getMessage

#define arginfo_class_Cancellation_getCode arginfo_class_Throwable_getCode

#define arginfo_class_Cancellation_getFile arginfo_class_Throwable_getMessage

#define arginfo_class_Cancellation_getLine arginfo_class_Throwable_getLine

#define arginfo_class_Cancellation_getTrace arginfo_class_Throwable_getTrace

#define arginfo_class_Cancellation_getPrevious arginfo_class_Throwable_getPrevious

#define arginfo_class_Cancellation_getTraceAsString arginfo_class_Throwable_getMessage

#define arginfo_class_Cancellation___toString arginfo_class_Throwable_getMessage
...
static const zend_function_entry class_Cancellation_methods[] = {
	ZEND_RAW_FENTRY("__clone", zim_Exception___clone, arginfo_class_Cancellation___clone, ZEND_ACC_PRIVATE, NULL, NULL)
	ZEND_RAW_FENTRY("__construct", zim_Exception___construct, arginfo_class_Cancellation___construct, ZEND_ACC_PUBLIC, NULL, NULL)
	ZEND_RAW_FENTRY("__wakeup", zim_Exception___wakeup, arginfo_class_Cancellation___wakeup, ZEND_ACC_PUBLIC, NULL, NULL)
	ZEND_RAW_FENTRY("getMessage", zim_Exception_getMessage, arginfo_class_Cancellation_getMessage, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL, NULL, NULL)
	ZEND_RAW_FENTRY("getCode", zim_Exception_getCode, arginfo_class_Cancellation_getCode, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL, NULL, NULL)
	ZEND_RAW_FENTRY("getFile", zim_Exception_getFile, arginfo_class_Cancellation_getFile, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL, NULL, NULL)
	ZEND_RAW_FENTRY("getLine", zim_Exception_getLine, arginfo_class_Cancellation_getLine, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL, NULL, NULL)
	ZEND_RAW_FENTRY("getTrace", zim_Exception_getTrace, arginfo_class_Cancellation_getTrace, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL, NULL, NULL)
	ZEND_RAW_FENTRY("getPrevious", zim_Exception_getPrevious, arginfo_class_Cancellation_getPrevious, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL, NULL, NULL)
	ZEND_RAW_FENTRY("getTraceAsString", zim_Exception_getTraceAsString, arginfo_class_Cancellation_getTraceAsString, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL, NULL, NULL)
	ZEND_RAW_FENTRY("__toString", zim_Exception___toString, arginfo_class_Cancellation___toString, ZEND_ACC_PUBLIC, NULL, NULL)
	ZEND_FE_END
};
...
static zend_class_entry *register_class_Cancellation(zend_class_entry *class_entry_Throwable)
{
	zend_class_entry ce, *class_entry;

	INIT_CLASS_ENTRY(ce, "Cancellation", class_Cancellation_methods);
	class_entry = zend_register_internal_class_with_flags(&ce, NULL, 0);
	zend_class_implements(class_entry, 1, class_entry_Throwable);
